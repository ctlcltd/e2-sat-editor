...
cp ../../dist/common/Readme.txt.in AppDir/usr/share/doc/e2se-cli/readme
cp ../COPYING AppDir/usr/share/doc/e2se-cli/copyright
...
mv e2se-cli-x86_64.AppImage e2se-cli-1.4.0-x86_64.AppImage

# ./e2se-cli-1.4.0-x86_64.AppImage --appimage-signature
