...
icons_win () {
	...
	convert res/e2-sat-editor/icon-512.png res/e2-sat-editor/icon-256.png res/e2-sat-editor/icon-128.png res/e2-sat-editor/icon-64.png res/e2-sat-editor/icon-48.png res/e2-sat-editor/icon-32.png dist/windows/e2-sat-editor.ico
}
...
icons_macx () {
	...
	cp res/e2-sat-editor/icon-{512,256,128,64,48,32}.png dist/macos/icons.iconset
	...
	mv dist/macos/icons.iconset/icon-48.png dist/macos/icons.iconset/icon_48x48.png
...
icons_ux () {
	...
	cp res/e2-sat-editor/icon-512.png dist/xdg/icons/512,512/e2-sat-editor.png
