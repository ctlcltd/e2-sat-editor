...
- [x] neutrino feparams and versions, unknown compatibility [gui] [e2db.cpp]
...
- [x] neutrino cable, atsc, unknown support [e2db.cpp]
- [ ] neutrino webtv support, Issues (#35) [e2db.cpp]
- [ ] neutrino feparams: frequency, symbol rate [e2db.cpp]
...
- [x] neutrino terrestrial, wrong syntax, eg. `name="NaN"` `name="0.0E"` [e2db.cpp]
