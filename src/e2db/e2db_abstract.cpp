...
{
	if (html == 2)
		return "e2 SAT Editor 0.5";
	else if (html == 1)
		return "e2 SAT Editor 0.5 <a href=\"https://github.com/ctlcltd/e2-sat-editor\">https://github.com/ctlcltd/e2-sat-editor</a>";
	else
		return "e2 SAT Editor 0.5 <https://github.com/ctlcltd/e2-sat-editor>";
}
