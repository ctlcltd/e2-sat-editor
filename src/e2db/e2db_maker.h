...
class e2db_maker : virtual public e2db_abstract
{
	public:
		...
		void make_bouquet(string bname, e2db_file& file, int ver);
		void make_bouquet_epl(string bname, e2db_file& file, int ver);
		void make_userbouquet(string bname, e2db_file& file, bool exact_marker_index, int ver);
		void make_userbouquet(string bname, e2db_file& file, int ver);
