...
class gui : protected e2se::log_factory
{
	...
	public:
		enum GUI_CXE {
			...
			FtpUpload = 79,
			FtpDownload = 76,
			ToolsLogInspector = 80,
			ToolsErrorChecker = 88,
			ToolsConsole = 85,
			ToolsUtilsOrphaned_services = 91,
			ToolsUtilsOrphaned_references = 92,
			ToolsUtilsFixRemove = 93,
			ToolsUtilsFixDVBNS = 99,
			ToolsUtilsFixBouquets = 100,
			ToolsUtilsFixBouquetsUniq = 101,
			ToolsUtilsClearServicesCached = 95,
			ToolsUtilsClearServicesCAID = 96,
			ToolsUtilsClearServicesFlags = 97,
			ToolsUtilsClearServicesData = 98,
			ToolsUtilsClearFavourites = 102,
		...
		inline static const vector<int> GUI_CXE__init = {
			...
			GUI_CXE::ToolsUtilsFixBouquets,
			GUI_CXE::ToolsUtilsFixBouquetsUniq,
		...
		enum TAB_ATS {
			...
			UtilsFixBouquets = GUI_CXE::ToolsUtilsFixBouquets,
			UtilsFixBouquetsUniq = GUI_CXE::ToolsUtilsFixBouquetsUniq, 
